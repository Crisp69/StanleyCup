...
function check(formular)
{
    ...
    else if (formular.q_full_a2.value=="")
    {
        alert("Select team!");
        formular.q_full_a2.focus();
        return false;
    }
    else if (formular.q_full_b2.value=="")
    {
        alert("Select team!");
        formular.q_full_b2.focus();
        return false;
    }
    ...
    else if (formular.q_full_a6.value=="")
    {
        alert("Select team!");
        formular.q_full_a6.focus();
        return false;
    }
    else if (formular.q_full_b6.value=="")
    {
        alert("Select team!");
        formular.q_full_b6.focus();
        return false;
    }    
	else 
        return true;
...
$playoff_file = $_SERVER['DOCUMENT_ROOT']."/stanleycup/data/schedule/playoff".$current_season.".txt";
    ...
    if(file_exists($playoff_file)) {
        ...
        while (!feof($f)) {
            $tmp = explode("|", fgets($f, 2000));
    		if (trim($tmp[0]) != "") {
                if(($tmp[0] == "Conference Semifinals") && $tmp[10] != "?") {
    ...
    if($count_results ==0) {
        echo "<br /><br /><b>Conference Semifinals</b><br /><br /><table align=\"center\"><tr><td colspan=\"2\">";
    	...
    	if(file_exists($stadings_file)) {
        	...
        	while(!feof($f)) {
        		...
        		if (trim($tmp[0]) != "") {
        			...
        			teamlist($team, $conf=$tmp[4], $pool = "q_full_a2");
        			}
        		}
        	}
        	...
        	while(!feof($f)) {
        		...
        		if (trim($tmp[0]) != "") {
        			...
        			teamlist($team, $conf=$tmp[4], $pool = "q_full_b2");
        			}
        		}
        	}
        	...
        	while(!feof($f)) {
        		...
        		if (trim($tmp[0]) != "") {
        			...
        			teamlist($team, $conf=$tmp[4], $pool = "q_full_a6");
        			}
        		}
        	}
        	...
        	while(!feof($f)) {
        		...
        		if (trim($tmp[0]) != "") {
        			...
        			teamlist($team, $conf=$tmp[4], $pool = "q_full_b6");
        			}
        		}
        	}
        	...
        	$gm1 = "Conference Semifinals|".$tmp_q_full_a1[1]."|".$tmp_q_full_b1[1]."|".$tmp_q_full_a1[2]."|".$tmp_q_full_b1[2]."|".$tmp_qf1_date[0]."|".$tmp_qf1_date[1]."|".$tmp_qf1_date[2]."|".$tmp_q_full_a1[0]."|".$tmp_q_full_b1[0]."|?|?|1||1017\n";
        	$tmp_q_full_a2 = explode(";",$q_full_a2);
        	$tmp_q_full_b2 = explode(";",$q_full_b2);
        	$gm2 = "Conference Semifinals|".$tmp_q_full_a2[1]."|".$tmp_q_full_b2[1]."|".$tmp_q_full_a2[2]."|".$tmp_q_full_b2[2]."|".$tmp_qf1_date[0]."|".$tmp_qf1_date[1]."|".$tmp_qf1_date[2]."|".$tmp_q_full_a2[0]."|".$tmp_q_full_b2[0]."|?|?|0||1018\n";
        	$tmp_q_full_a5 = explode(";",$q_full_a5);
        	$tmp_q_full_b5 = explode(";",$q_full_b5);
        	$gm5 = "Conference Semifinals|".$tmp_q_full_a5[1]."|".$tmp_q_full_b5[1]."|".$tmp_q_full_a5[2]."|".$tmp_q_full_b5[2]."|".$tmp_qf1_date[0]."|".$tmp_qf1_date[1]."|".$tmp_qf1_date[2]."|".$tmp_q_full_a5[0]."|".$tmp_q_full_b5[0]."|?|?|0||1019\n";
        	$tmp_q_full_a6 = explode(";",$q_full_a6);
        	$tmp_q_full_b6 = explode(";",$q_full_b6);
        	$gm6 = "Conference Semifinals|".$tmp_q_full_a6[1]."|".$tmp_q_full_b6[1]."|".$tmp_q_full_a6[2]."|".$tmp_q_full_b6[2]."|".$tmp_qf1_date[0]."|".$tmp_qf1_date[1]."|".$tmp_qf1_date[2]."|".$tmp_q_full_a6[0]."|".$tmp_q_full_b6[0]."|?|?|2||1020\n";
        	$gm9 = "Conference Semifinals|".$tmp_q_full_b1[1]."|".$tmp_q_full_a1[1]."|".$tmp_q_full_b1[2]."|".$tmp_q_full_a1[2]."|".$tmp_qf2_date[0]."|".$tmp_qf2_date[1]."|".$tmp_qf2_date[2]."|".$tmp_q_full_b1[0]."|".$tmp_q_full_a1[0]."|?|?|1||1021\n";
        	$gm10 = "Conference Semifinals|".$tmp_q_full_b2[1]."|".$tmp_q_full_a2[1]."|".$tmp_q_full_b2[2]."|".$tmp_q_full_a2[2]."|".$tmp_qf2_date[0]."|".$tmp_qf2_date[1]."|".$tmp_qf2_date[2]."|".$tmp_q_full_b2[0]."|".$tmp_q_full_a2[0]."|?|?|0||1022\n";
        	$gm13 = "Conference Semifinals|".$tmp_q_full_b5[1]."|".$tmp_q_full_a5[1]."|".$tmp_q_full_b5[2]."|".$tmp_q_full_a5[2]."|".$tmp_qf2_date[0]."|".$tmp_qf2_date[1]."|".$tmp_qf2_date[2]."|".$tmp_q_full_b5[0]."|".$tmp_q_full_a5[0]."|?|?|0||1023\n";
        	$gm14 = "Conference Semifinals|".$tmp_q_full_b6[1]."|".$tmp_q_full_a6[1]."|".$tmp_q_full_b6[2]."|".$tmp_q_full_a6[2]."|".$tmp_qf2_date[0]."|".$tmp_qf2_date[1]."|".$tmp_qf2_date[2]."|".$tmp_q_full_b6[0]."|".$tmp_q_full_a6[0]."|?|?|2||1024\n";
        ...
        //	echo $gm16."<br />";
        		...
        		$write = $gm1.$gm2.$gm5.$gm6.$gm9.$gm10.$gm13.$gm14;
                
                $playoff_file_tmp = $_SERVER['DOCUMENT_ROOT']."/stanleycup/update/tmp/playoff".$current_season."csf.txt";
