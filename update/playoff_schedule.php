...
<?
function teamlist($team, $pool) {
	$team_dir = $_SERVER['DOCUMENT_ROOT']."/stanleycup/data/teams/teams.txt";
	echo "<table>";
	echo "<tr><td>&nbsp;<select name=\"$pool\"class=\"list\">";
	$f = fopen($team_dir,"r");
	while(!feof($f)) {
...
$playoff_file = $_SERVER['DOCUMENT_ROOT']."/stanleycup/data/schedule/playoff".$current_season.".txt";
    ...
    echo "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"0; URL=playoff_schedule_quarterfinals.php\">";
    }
    else {
        echo "<br /><br /><br /><br />";
        echo "<a href=\"playoff_schedule_quarterfinals.php\">create / edit schedule for CONF QUARTERFINALS</a><p>";
        echo "<a href=\"playoff_schedule_semifinals.php\">create / edit schedule for CONF SEMIFINALS</a><p>";
        echo "<a href=\"playoff_schedule_conffinals.php\">create / edit schedule for CONF FINALS</a><p>";
        echo "<a href=\"playoff_schedule_scfinals.php\">create / edit schedule for SC FINALS</a><p>";
    }    
