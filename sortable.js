...
var ml_tsort = {
  ...
  sort_col_style_post_sort : "text-decoration:underline; color:black", // whichever style you want the link to look like when the column for the link was sorted
  sort_col_mouseover : "this.style.color='#777777'", // what style the link should use onmouseover?
  ...
  default_sort_asc : false, // if true then by default, the first sort on the table would be in ascending order
  ...
  table_head_row : 1, // do not sort the first ? number of rows of the table with headers
