...
if ($upload_process == "php") {
	...
	<option value=\"upload.php?page=data\">&nbsp;data </option>
	<option value=\"upload.php?page=stars\">&nbsp;stars </option>
	<option value=\"upload.php?page=magazine\">&nbsp;magazine </option>
	<option value=\"upload.php?page=magazine/comments\">&nbsp;comments </option>
...
if ($dir_handle) {
	while (false !==($file = readdir($dir_handle))) {
		...
		if (((is_file($upload_files)) && ($file!=".htaccess")) && (($file ==$up_ignore1) || ($file ==$up_ignore2) || ($file ==$up_ignore3) || ($file ==$up_ignore4) || ($file ==$up_ignore)) || ($file ==$up_ignore5)|| ($file ==$up_ignore6)|| ($file ==$up_ignore7)|| ($file ==$up_ignore8)|| ($file ==$up_ignore9)|| ($file ==$up_ignore10)|| ($file ==$up_ignore11)|| ($file ==$up_ignore12)) {
...
<td class=\"uploadlistloc\"><a href=\"http://".$_SERVER['HTTP_HOST']."/data/$dir/$file\">http://".$_SERVER['HTTP_HOST']."/data/$dir/$file</a></td>
</tr>";
}
closedir($dir_handle);
echo "</table>";
